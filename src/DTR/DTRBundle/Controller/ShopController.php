...
use DTR\DTRBundle\Form\ShopType;
...
class ShopController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DTRBundle:Shop')->findAll();
     ...
     * @Method("POST")
     * @Template("DTRBundle:Shop:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DTRBundle:Shop')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DTRBundle:Shop:edit.html.twig")
     */
